...
def main():
    ...
    app = InteractiveDemoApp(root, args, model, cfg)
    root.deiconify()
    app.mainloop()
...
def parse_args():
    ...
    parser.add_argument('--fixed-h', type=int, default=None, help='resize to fixed height')
    parser.add_argument('--fixed-w', type=int, default=None, help='resize to fixed width')
